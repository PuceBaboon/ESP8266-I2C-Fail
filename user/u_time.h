/*
 * $Id: u_time.h,v 1.11 2015/07/23 10:40:14 anoncvs Exp $
 *
 ...
 */
void	timet_to_tm(time_t time, struct tm_struc *tmel);	// Convert a time_t value into "struct tm" elements.
time_t	tm_to_timet(struct tm_struc *tmel);			// Reconstitute "struct tm" elements into a time_t value.
